...
import project.controller.duel.GamePhaseControllers.ChainController;
import project.controller.duel.GamePhaseControllers.SelectCardController;
import project.controller.duel.GamePhaseControllers.SpecialSummonController;
    ...
    public String AttackConductor(int index, int numberInListOfActions) {
        ...
        if (!action.isActionCanceled()) {
            ...
            if (defendingMonsterCard.getCardPosition().equals(CardPosition.FACE_DOWN_MONSTER_SET_POSITION)) {
                ...
                GameManager.getDuelControllerByIndex(index).addStringToSuperAlmightyString("mainCardLocation " + defendingMonsterCardLocation.getRowOfCardLocation()
