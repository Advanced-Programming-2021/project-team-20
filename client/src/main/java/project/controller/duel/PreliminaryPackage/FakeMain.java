...
public class FakeMain {
    ...
    public static void addCardsToFirstPlayer(ArrayList<Card> firstPlayerDeck) {
     ...
     //   firstPlayerDeck.add(new SpellCard("Messenger Of Peace", "", SpellCardValue.CONTINUOUS, null, 3, 60, 0, null, null));
        ...
        firstPlayerDeck.add(new MonsterCard(3500, 0, 8, MonsterCardAttribute.EARTH, MonsterCardFamily.CYBERSE, MonsterCardValue.NORMAL, "Beast King Barbaros", "", null, 3, 0, null, null));

       // firstPlayerDeck.add(new SpellCard("Umiiruka", "", SpellCardValue.FIELD, null, 3, 60, 0, null, null));
    //    firstPlayerDeck.add(new SpellCard("Supply Squad", "", SpellCardValue.CONTINUOUS, null, 3, 60, 0, null, null));
    //    firstPlayerDeck.add(new SpellCard("Spell Absorption", "", SpellCardValue.CONTINUOUS, null, 3, 60, 0, null, null));
        firstPlayerDeck.add(new MonsterCard(2000, 0, 4, MonsterCardAttribute.EARTH, MonsterCardFamily.CYBERSE, MonsterCardValue.NORMAL, "The Tricky", "", null, 3, 0, null, null));
        firstPlayerDeck.add(new MonsterCard(2000, 0, 4, MonsterCardAttribute.EARTH, MonsterCardFamily.CYBERSE, MonsterCardValue.NORMAL, "The Tricky", "", null, 3, 0, null, null));
        firstPlayerDeck.add(new MonsterCard(2000, 0, 4, MonsterCardAttribute.EARTH, MonsterCardFamily.CYBERSE, MonsterCardValue.NORMAL, "The Tricky", "", null, 3, 0, null, null));
...
//        firstPlayerDeck.add(new SpellCard("Advanced Ritual Art", "", SpellCardValue.RITUAL, null, 3, 60, 0, null, null));
   ...
   //     secondPlayerDeck.add(new SpellCard("Raigeki", "", SpellCardValue.NORMAL, null, 3, 60, 0, null, null));
      ...
      //  secondPlayerDeck.add(new MonsterCard(0, 0, 1, MonsterCardAttribute.LIGHT, MonsterCardFamily.SPELLCASTER, MonsterCardValue.NORMAL, "Scanner", "", null, 3, 0, null, null));
  ...
  //      secondPlayerDeck.add(new SpellCard("Twin Twisters", "", SpellCardValue.QUICK_PLAY, null, 3, 6, 0, null, null));
        ...
        secondPlayerDeck.add(new MonsterCard(300, 1900, 4, MonsterCardAttribute.LIGHT, MonsterCardFamily.SPELLCASTER, MonsterCardValue.NORMAL, "Man-Eater Bug", "", null, 3, 0, null, null));
        secondPlayerDeck.add(new MonsterCard(1800, 1200, 4, MonsterCardAttribute.LIGHT, MonsterCardFamily.SPELLCASTER, MonsterCardValue.NORMAL, "Herald Of Creation", "", null, 3, 0, null, null));
        /*
