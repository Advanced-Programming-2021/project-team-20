...
import sample.controller.duel.CardEffects.EffectImplementations.*;
    ...
    public String isSelectedCardCorrectForChainActivation(String string, int index) {
        ...
        if (isAlreadyActivated) {
            ...
            if (!chainSpellTrapIsCorrect) {
                ...
                ArrayList<String> inputsNeeded = Effect.inputsNeededForActivatingSpellTrapCard(cardLocation, index);
