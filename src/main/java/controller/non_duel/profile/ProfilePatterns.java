...
public class ProfilePatterns {
    ...
    private Pattern changePassword1 = Pattern
            .compile("profile change (-p|--password) (-c|--current) (?<current>\\S+) (-n|--new) (?<new>\\S+)");
    private Pattern changePassword2 = Pattern
            .compile("profile change (-p|--password) (-n|--new) (?<new>\\S+) (-c|--current) (?<current>\\S+)");
    private Pattern changePassword3 = Pattern
            .compile("profile change (-n|--new) (?<new>\\S+) (-p|--password) (-c|--current) (?<current>\\S+)");
    private Pattern changePassword4 = Pattern
            .compile("profile change (-c|--current) (?<current>\\S+) (-n|--new) (?<new>\\S+) (-p|--password)");
    private Pattern changePassword5 = Pattern
            .compile("profile change (-c|--current) (?<current>\\S+) (-p|--password) (-n|--new) (?<new>\\S+)");
    private Pattern changePassword6 = Pattern
            .compile("profile change (-n|--new) (?<new>\\S+) (-c|--current) (?<current>\\S+) (-p|--password)");
