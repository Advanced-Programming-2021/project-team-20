...
public class HealthBarAndHealthPoints {
    ...
    public HealthBarAndHealthPoints(boolean isForAlly, int previousHealth) {
        ...
        Rectangle first = new Rectangle(100, (isForAlly ? correctStageHeight : 0), 50, digitHeight);
        first.setViewOrder(1);
        healthDigits.add(first);
        Rectangle second = new Rectangle(150, (isForAlly ? correctStageHeight : 0), 50, digitHeight);
        second.setViewOrder(1);
        healthDigits.add(second);
        Rectangle third =new Rectangle(200, (isForAlly ? correctStageHeight : 0), 50, digitHeight);
        third.setViewOrder(1);
        healthDigits.add(third);
        Rectangle fourth = new Rectangle(250, (isForAlly ? correctStageHeight : 0), 50, digitHeight);
        fourth.setViewOrder(1);
        healthDigits.add(fourth);
