...
public class FakeMain {
    ...
    public static void addCardsToFirstPlayer(ArrayList<Card> firstPlayerDeck) {
        ...
        firstPlayerDeck.add(new SpellCard("PotOfGreed", "", SpellCardValue.NORMAL, null, 3, 60, 0, null));
       ...
       //firstPlayerDeck.add(new SpellCard("terraforming", "", SpellCardValue.NORMAL, null, 3, 60, 0, null));
        firstPlayerDeck.add(new TrapCard("TorrentialTribute", "", TrapCardValue.NORMAL, null, 3, 60, 0, null));
        //firstPlayerDeck.add(new SpellCard("messenger of peace", "", SpellCardValue.CONTINUOUS, null, 3, 6, 0, null));
        firstPlayerDeck.add(new SpellCard("Umiiruka", "", SpellCardValue.FIELD, null, 3, 60, 0, null));

        firstPlayerDeck.add(new TrapCard("MirrorForce", "", TrapCardValue.NORMAL, null, 3, 60, 0, null));
        firstPlayerDeck.add(new MonsterCard(2000, 0, 4, MonsterCardAttribute.LIGHT, MonsterCardFamily.SPELLCASTER, MonsterCardValue.NORMAL, "AlexandriteDragon", "", null, 3, 0, null));
        ...
        firstPlayerDeck.add(new MonsterCard(1000, 0, 3, MonsterCardAttribute.DARK, MonsterCardFamily.FIEND, MonsterCardValue.NORMAL, "ExploderDragon", "", null, 3, 0, null));
        /*
    ...
    public static void addCardsToSecondPlayer(ArrayList<Card> secondPlayerDeck) {
        ...
        secondPlayerDeck.add(new SpellCard("TwinTwisters", "", SpellCardValue.QUICK_PLAY, null, 3, 6, 0, null));
        //secondPlayerDeck.add(new TrapCard("Call Of The Hunted", "", TrapCardValue.NORMAL, null, 3, 60, 0, null));
        secondPlayerDeck.add(new SpellCard("Umiiruka", "", SpellCardValue.FIELD, null, 3, 60, 0, null));
        secondPlayerDeck.add(new SpellCard("Raigeki", "", SpellCardValue.NORMAL, null, 3, 60, 0, null));


        secondPlayerDeck.add(new MonsterCard(1800, 1200, 4, MonsterCardAttribute.EARTH, MonsterCardFamily.WARRIOR, MonsterCardValue.EFFECT, "Terratiger", "", null, 3, 0, null));
        //terratiger effect won't work because of invalid string name in controller
        secondPlayerDeck.add(new TrapCard("MirrorForce", "", TrapCardValue.NORMAL, null, 3, 60, 0, null));
        secondPlayerDeck.add(new MonsterCard(200, 1800, 2, MonsterCardAttribute.LIGHT, MonsterCardFamily.SPELLCASTER, MonsterCardValue.NORMAL, "Bitron", "", null, 3, 0, null));
        ...
        secondPlayerDeck.add(new MonsterCard(2000, 0, 4, MonsterCardAttribute.LIGHT, MonsterCardFamily.SPELLCASTER, MonsterCardValue.NORMAL, "AlexandriteDragon", "", null, 3, 0, null));
        secondPlayerDeck.add(new MonsterCard(300, 1900, 4, MonsterCardAttribute.LIGHT, MonsterCardFamily.SPELLCASTER, MonsterCardValue.NORMAL, "ManEaterBug", "", null, 3, 0, null));
        secondPlayerDeck.add(new MonsterCard(1800, 1200, 4, MonsterCardAttribute.LIGHT, MonsterCardFamily.SPELLCASTER, MonsterCardValue.NORMAL, "HeraldOfCreation", "", null, 3, 0, null));
        /*
