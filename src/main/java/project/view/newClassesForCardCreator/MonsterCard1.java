...
public class MonsterCard1 {
    public MonsterCard1(int attackPowerMonsterCard, int defencePowerMonsterCard, int levelOfMonsterCard, MonsterCardAttribute attributeMonster, MonsterCardFamily familyMonster, MonsterCardValue valueMonster, String cardName, String cardDescription, CardPosition notApplicable, int numberOfAllowedUsages, int i, HashMap<String, List<String>> hashMapEffects, Image cardImage, HashMap<String, Integer> numbersOfEffectsToSend) {
