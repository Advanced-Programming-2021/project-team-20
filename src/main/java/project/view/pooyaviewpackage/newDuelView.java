...
public class newDuelView implements Initializable {
    ...
    private void prepareObjectsForWorking() {
        ...
        for (int i = 0; i < allyCardsInDeck.size() + allyCardsInHand.size(); i++) {
            ...
            // CardView cardView = new CardView(currentCardForView, true,
            // RowOfCardLocation.ALLY_DECK_ZONE, this);
        ...
        for (int i = 0; i < opponentCardsInDeck.size() + opponentCardsInHand.size(); i++) {
            ...
            // CardView cardView = new CardView(currentCardForView, true,
            // RowOfCardLocation.OPPONENT_DECK_ZONE, this);
            // cardView.applyClickingAbilitiesToCardView(this);
            // cardView.applyDragDetectingAbilityToCardView();
            // System.out.println("preparing " + cardView.getCard().getCardName());
            // allCards.getChildren().add(cardView);
    ...
    // public static void setxHelperForCardViewConstructor(double
    // xHelperForCardViewConstructor) {
    // DuelView.xHelperForCardViewConstructor = xHelperForCardViewConstructor;
    // }

    // public static void setyHelperForCardViewConstructor(double
    // yHelperForCardViewConstructor) {
    ...
    // public static void setRowOfCardLocationOfFinalDraggedPoint(RowOfCardLocation
    // rowOfCardLocationOfFinalDraggedPoint) {
    // DuelView.rowOfCardLocationOfFinalDraggedPoint =
    // rowOfCardLocationOfFinalDraggedPoint;
    // }

    // public static void setRowOfCardLocationOfInitialDraggedPoint(
    // RowOfCardLocation rowOfCardLocationOfInitialDraggedPoint) {
    // DuelView.rowOfCardLocationOfInitialDraggedPoint =
    // rowOfCardLocationOfInitialDraggedPoint;
    // }
    ...
    // public static void setShouldDuelViewClickingAbilitiesWork(boolean
    // shouldDuelViewClickingAbilitiesWork) {
    // DuelView.shouldDuelViewClickingAbilitiesWork =
    // shouldDuelViewClickingAbilitiesWork;
    // }
    ...
    // public static void setCardLocationLookingRightNow(CardLocation
    // cardLocationLookingRightNow) {
    // DuelView.cardLocationLookingRightNow = cardLocationLookingRightNow;
    // }

    // public static void setCardLocationSelecting(CardLocation
    // cardLocationSelecting) {
    // DuelView.cardLocationSelecting = cardLocationSelecting;
    // }

    // public static void setIsWaitingForRightClickOptionListHit(boolean
    // isWaitingForRightClickOptionListHit) {
    // DuelView.isWaitingForRightClickOptionListHit =
    // isWaitingForRightClickOptionListHit;
    // }
    ...
    // public static void setCardLocationToSendCardTo(CardLocation
    // cardLocationToSendCardTo) {
    ...
    // public static void setCardLocationBeingDragged(CardLocation
    // cardLocationBeingDragged) {
