...
import project.model.aidata.AIBoardAnalysis;
...
public class AIKeyVariablesUpdater {
    ...
    private boolean doesAIHaveSpecialSummoningMonstersInHand;
    private boolean doesAIHaveCardRemovalSpellsInHand;
    ...
    protected void updateVariablesOfThisClassAccordingToSituation(AI ai) {
        ...
        if (aiHandBoardAnalysis.getIndexesOfSpecialSummoningMonsters().size() > 0) {
            doesAIHaveSpecialSummoningMonstersInHand = true;
        }
        if (aiHandBoardAnalysis.getIndexesOfCardRemovalSpells().size()>0){
            doesAIHaveCardRemovalSpellsInHand = true;
        }
    ...
    public boolean isDoesAIHaveSpecialSummoningMonstersInHand() {
        return doesAIHaveSpecialSummoningMonstersInHand;
    }

    public boolean isDoesAIHaveCardRemovalSpellsInHand() {
        return doesAIHaveCardRemovalSpellsInHand;
    }
    ...
    public void clearVariables() {
        ...
        doesAIHaveCardRemovalSpellsInHand = false;
        doesAIHaveSpecialSummoningMonstersInHand = false;
    }
}
