...
public class NormalSummonConductor {
    ...
    private static boolean promptingUserToChooseMonsterToDestroy = false;
    ...
    public static boolean isPromptingUserToChooseMonsterToDestroy() {
        return promptingUserToChooseMonsterToDestroy;
    }
    ...
    public static String conductNormalSummoningAction(String token, int numberInListOfActions) {
        ...
        if (!action.isActionCanceled()) {
            ...
            if (uponSummoningEffects.contains(UponSummoningEffect.SELECT_1_CARD_ON_THE_FIELD_AND_DESTROY)) {
                shouldRedirectConductorToAvoidRepetition = true;
                promptingUserToChooseMonsterToDestroy = true;
    ...
    public static String checkGivenInputForCardToDestroy(String token) {
        ...
        promptingUserToChooseMonsterToDestroy = false;
