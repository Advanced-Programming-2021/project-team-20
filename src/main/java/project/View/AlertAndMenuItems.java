...
public class AlertAndMenuItems {
    ...
    public void getRitualSummoningMenuItem(CardView cardView, MenuItem item) {
        ...
        item.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                CardLocation cardLocationSelecting = DuelView.getCardLocationSelecting();
                if (cardLocationSelecting != null) {
                    DuelView.getSendingRequestsToServer().sendRitualSummoningRequestToServer(cardView, cardLocationSelecting);
                }
                //label.setText("Select Menu Item 1");
            }
        });
    ...
    public void getSpecialSummoningMenuItem(CardView cardView, MenuItem item) {
        ...
        item.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                CardLocation cardLocationSelecting = DuelView.getCardLocationSelecting();
                if (cardLocationSelecting != null) {
                    DuelView.getSendingRequestsToServer().sendSpecialSummoningRequestToServer(cardView, cardLocationSelecting);
                }
                //label.setText("Select Menu Item 1");
            }
        });
    ...
    public void getTributeSummoningMenuItem(CardView cardView, MenuItem item) {
        ...
        item.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                CardLocation cardLocationSelecting = DuelView.getCardLocationSelecting();
                if (cardLocationSelecting != null) {
                    DuelView.getSendingRequestsToServer().sendTributeSummoningRequestToServer(cardView, cardLocationSelecting);
                }
                //label.setText("Select Menu Item 1");
            }
        });
    ...
    public void getNormalSummoningMenuItem(CardView cardView, MenuItem item) {
    ...
    public void showAllSummonOptionsAlertForMonsterCard(CardView cardViewBeingDragged, CardLocation initialCardLocation) {
        ...
        if (result.equals(normalSummonButton)) {
            DuelView.getSendingRequestsToServer().sendNormalSummoningRequestToServer(cardViewBeingDragged, initialCardLocation);
        } else if (result.equals(tributeSummonButton)) {
            DuelView.getSendingRequestsToServer().sendTributeSummoningRequestToServer(cardViewBeingDragged, initialCardLocation);
        } else if (result.equals(specialSummonButton)) {
            DuelView.getSendingRequestsToServer().sendSpecialSummoningRequestToServer(cardViewBeingDragged, initialCardLocation);
        } else if (result.equals(ritualSummonButton)) {
            DuelView.getSendingRequestsToServer().sendRitualSummoningRequestToServer(cardViewBeingDragged, initialCardLocation);
