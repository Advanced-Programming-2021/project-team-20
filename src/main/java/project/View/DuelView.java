                ...
                if (e.getButton().equals(MouseButton.PRIMARY)) {
                    if (!dragFlag) {
                        ...
                        if (e.getClickCount() == 1) {
                            //scheduledFuture = executor.schedule(() -> singleClickAction(e.getX(), e.getY()), 10000, TimeUnit.MILLISECONDS);
        ...
        */
        ...
        anchorPane.setOnDragDropped(e -> {
            if (draggingObject != null &&
                ...
                //System.out.println("initial x is " + draggingObjectX + " and initial y is " + draggingObjectY);
...
//
//        Image image = new Image(DuelView.class.getResource("/project/cards/monsters/AlexandriteDragon.jpg").toExternalForm());
//
...
//
//            Image image = new Image(CardView.class.getResource("/project/cards/monsters/AlexandriteDragon.jpg").toExternalForm());
//
            ...
            public void handle(MouseEvent e) {
                if (e.getButton().equals(MouseButton.PRIMARY)) {
                    if (!dragFlag) {
                        System.out.println(++clickCounter + " " + e.getClickCount());
                        if (e.getClickCount() == 1) {
                            scheduledFuture = executor.schedule(() -> singleClickAction(e, cardView), 300, TimeUnit.MILLISECONDS);
                        } else if (e.getClickCount() > 1) {
                            if (scheduledFuture != null && !scheduledFuture.isCancelled() && !scheduledFuture.isDone()) {
                                scheduledFuture.cancel(false);
                                doubleClickAction(e);
...
//                && e.getDragboard().getString().equals("card")) {
//                draggingObject = null;
//                cardLocationDragDropped = controllerForView.giveCardLocationByCoordinateInView(e,null);
//                System.out.println("cardLocationDragDropped is "+cardLocationDragDropped.getRowOfCardLocation()+" "+cardLocationDragDropped.getIndex());
//                System.out.println("wow");
//                e.setDropCompleted(true);
//            }
//        });
    ...
    private void takeCareOfDraggingAction(CardLocation initialCardLocation, CardLocation finalCardLocation, CardView cardViewBeingDragged, TwoDimensionalPoint finalTwoDimensionalPoint) {
    ...
    public static void printChildrenInGroups() {
        ...
        for (int i = 0; i < controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.ALLY_DECK_ZONE).size(); i++) {
            System.out.println(((CardView) controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.ALLY_DECK_ZONE).get(i)).getCard().getCardName());
        }
        ...
        for (int i = 0; i < controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.ALLY_HAND_ZONE).size(); i++) {
            System.out.println(((CardView) controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.ALLY_HAND_ZONE).get(i)).getCard().getCardName());
        }
        ...
        for (int i = 0; i < controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.ALLY_GRAVEYARD_ZONE).size(); i++) {
            System.out.println(((CardView) controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.ALLY_GRAVEYARD_ZONE).get(i)).getCard().getCardName());
        }
        ...
        for (int i = 0; i < controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.OPPONENT_DECK_ZONE).size(); i++) {
            System.out.println(((CardView) controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.OPPONENT_DECK_ZONE).get(i)).getCard().getCardName());
        }
        ...
        for (int i = 0; i < controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.OPPONENT_HAND_ZONE).size(); i++) {
            System.out.println(((CardView) controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.OPPONENT_HAND_ZONE).get(i)).getCard().getCardName());
        }
        ...
        for (int i = 0; i < controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.OPPONENT_GRAVEYARD_ZONE).size(); i++) {
            System.out.println(((CardView) controllerForView.giveCardViewWithThisLabel(RowOfCardLocation.OPPONENT_GRAVEYARD_ZONE).get(i)).getCard().getCardName());
        }
    }
