...
public class AIBoardAnalysis {
    ...
    private ArrayList<Integer> indexesOfSpecialSummoningMonsters;
    private ArrayList<Integer> indexesOfCardRemovalSpells;
    ...
    public AIBoardAnalysis() {
        ...
        indexesOfSpecialSummoningMonsters = new ArrayList<>();
        indexesOfCardRemovalSpells = new ArrayList<>();
    }
    ...
    public ArrayList<Integer> getIndexesOfSpecialSummoningMonsters() {
        return indexesOfSpecialSummoningMonsters;
    }

    public ArrayList<Integer> getIndexesOfCardRemovalSpells() {
        return indexesOfCardRemovalSpells;
    }
    ...
    public void clearVariables() {
        ...
        indexesOfSpecialSummoningMonsters.clear();
        indexesOfCardRemovalSpells.clear();
    }
}
