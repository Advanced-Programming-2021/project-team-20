...
public class SpellCard extends Card {
    ...
    public SpellCard(String cardName, String cardDescription, SpellCardValue spellCardValue, CardPosition cardPosition,
                     ...
                     HashMap<String, List<String>> enumValues, Image image, ArrayList<MonsterCardFamily> monsterCardFamilies, ArrayList<Integer> integers) {
    ...
    private void setEnumValues(HashMap<String, List<String>> enumValues, ArrayList<MonsterCardFamily> monsterCardFamilies, ArrayList<Integer> integers) {
        ...
        equipSpellExtendedEffects.add(new EquipSpellExtendedEffect(equipSpellEffects, monsterCardFamilies, integers, this.getCardName()));
        ...
        fieldSpellExtendedEffects.add(new FieldSpellExtendedEffect(fieldSpellEffects, monsterCardFamilies, integers, this.getCardName()));
